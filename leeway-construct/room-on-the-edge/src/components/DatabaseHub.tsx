// Removed ThreeDScene placeholder. All 3D rendering is now handled by PalliumVisuals.tsx.
...
// Use imported firebase utilities
          ...
          >
            ...
            <div className="pt-4 md:pt-6 border-t border-slate-800 flex flex-col gap-3 md:gap-4 shrink-0">
              ...
              <div className="flex flex-col gap-2">
                <button 
                  className="flex items-center justify-center gap-2 w-full py-3 md:py-4 bg-green-600 hover:bg-green-500 text-white rounded-xl font-black text-[10px] md:text-xs uppercase tracking-widest transition-all shadow-lg shadow-green-900/20"
                  onClick={() => alert(`Forging Deployable Agent Package for ${DB_INFO[selectedDb].name}...`)}
                >
                  <Cpu className="w-3.5 h-3.5 md:w-4 md:h-4" /> Forge & Deploy
                </button>
                
                <button 
                  className="flex items-center justify-center gap-2 w-full py-3 md:py-4 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl font-black text-[10px] md:text-xs uppercase tracking-widest transition-all shadow-lg shadow-indigo-900/20"
                  onClick={() => alert('Generating Leeway Emissary Thin-Client...')}
                >
                  <Terminal className="w-3.5 h-3.5 md:w-4 md:h-4" /> Export Emissary
                </button>
